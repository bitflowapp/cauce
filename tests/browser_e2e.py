...
with sync_playwright() as playwright:
    ...
    try:
        ...
        page.locator('input[name="address"]').fill('Calle de prueba 123')
        ...
        form.locator('input[name="price"]').fill('6000')
        form.locator('input[name="stock"]').fill('1')
        ...
        navigate(page,'cart/orilla')
        page.locator('[data-action="fill-demo-checkout"]').click()
        page.locator('input[name="name"]').fill('<img src=x onerror=alert(1)>')
        page.locator('[data-testid="confirm-order"]').click()
        navigate(page,'business/orilla')
