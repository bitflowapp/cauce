...
await writeFile(resolve(output,'DEPLOYMENT-NOTICE.txt'),'CAUCE 0.3.0 — DEMOSTRACIÓN LOCAL. No es una release candidata de producción. Sin autenticación, backend, pagos ni GPS reales.\n');
